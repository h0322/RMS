...
var _2a5=$.fn.diaConfig.log.methods[_2a3];
if(_2a5){
...
$.data(this,"dialog",{options:$.extend({},$.fn.diaConfig.log.defaults,$.fn.diaConfig.log.parseOptions(this),_2a3)});
}
_295(this);
});
};
$.fn.diaConfig.log.methods={options:function(jq){
...
$.fn.diaConfig.log.parseOptions=function(_2a9){
var t=$(_2a9);
...
$.fn.diaConfig.log.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
function _2aa(){
...
$.messager.defaults=$.extend({},$.fn.diaConfig.log.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
